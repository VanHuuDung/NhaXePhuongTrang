...
@foreach($chitietdatves as $key => $chitietdatve)
    <div class="cardWrap">
        <div class="card cardLeft">
            <h1>Nhà Xe <span>Phương Trang</span></h1>
            <div class="title">
            <h2>{{$chitietdatve->Tuyen}}</h2>
            <span>Tuyến Xe</span>
            </div>
            <div class="name">
            <h2>{{$chitietdatve->BienSoXe}}</h2>
            <span>Biển Số</span>
            </div>
            <div class="seat">
            <h2>{{number_format($chitietdatve->Gia, 0, '', '.')}} vnđ</h2>
            <span>Giá tiền</span>
            </div>
            <div class="time">
            <h2>{{$chitietdatve->NgayXuatPhat}}</h2>
            <span>Ngày Khỏi Hành</span>
            </div>
